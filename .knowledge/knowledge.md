...
**AUTHORITY & USAGE NOTE:**

This file provides detailed implementation patterns and conventions.

**Constitution supersedes all:** `.specify/memory/constitution.md` is final authority on principles.

**Agent usage:** Agents reference this file to avoid duplication. See `.knowledge/knowledge-dependencies.md` for what each agent needs.

**Dependency tracking:** When updating this file, update line number references in `.knowledge/knowledge-dependencies.md`.

---

## Quick Navigation

Use these line number references when linking from agent files:

- **Tech Stack** - Lines 5-7
- **Path Aliases** - Lines 51-58
- **Refactoring Principles** - Lines 59-83
- **Architecture Overview** - Lines 84-85
- **Component Structure (7 Regions)** - Lines 86-295
- **Naming Conventions** - Lines 296-395
- **Context API Patterns** - Lines 387-395
- **State Management Decision Tree** - Lines 396-446
- **Performance Optimization** - Lines 447-503
- **Routing** - Lines 504+
- **Internationalization** - See i18n sections throughout
- **Templates** - See `.knowledge/templates/README.md`
